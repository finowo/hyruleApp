...
class SampleDataProvider {
    ...
    companion object {
        ...
        fun getHyruleEntities() = arrayListOf(
            HyruleEntity(getDate(0), sampleHyruleEntity1),
            HyruleEntity(getDate(1), sampleHyruleEntity2),
            HyruleEntity(getDate(2), sampleHyruleEntity3),
            HyruleEntity(getDate(3), sampleHyruleEntity4),
            HyruleEntity(getDate(4), sampleHyruleEntity5),
        )
